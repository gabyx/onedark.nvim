...
hl.common = {
	...
	FloatBorder = { fg = c.grey, bg = c.bg4 },
...
hl.syntax = {
	...
	Identifier = { fg = c.blue, fmt = cfg.code_style.variables },
	Constant = colors.Cyan,
	PreProc = colors.Orange,
	PreCondit = colors.Orange,
	Include = colors.Purple,
	Keyword = { fg = c.yellow, fmt = cfg.code_style.keywords },
...
if vim.api.nvim_call_function("has", { "nvim-0.8" }) == 1 then
	hl.treesitter = {
		...
		["@constant.builtin"] = { fg = c.purple, fmt = cfg.code_style.constants },
		...
		["@function.builtin"] = { fg = c.dark_yellow, fmt = cfg.code_style.functions },
		["@function.macro"] = { fg = c.orange, fmt = cfg.code_style.functions },
		["@include"] = colors.Purple,
		["@keyword"] = { fg = c.blue, fmt = cfg.code_style.keywords },
		["@keyword.function"] = { fg = c.blue1, fmt = cfg.code_style.functions },
		["@keyword.operator"] = { fg = c.blue3, fmt = cfg.code_style.keywords },
		["@label"] = colors.Red,
		["@method"] = { fg = c.yellow, fmt = cfg.code_style.functions },
		["@namespace"] = { fg = c.blue1 },
		["@none"] = colors.Fg,
		["@number"] = colors.Orange,
		["@operator"] = { fg = c.orange },
		["@parameter"] = { fg = c.yellow1 },
